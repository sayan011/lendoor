...
describe("StableCoinToken", function () {
  let stableCoinToken: StableCoinToken;
  ...
  beforeEach(async function () {
    ...
    const stableCoinTokenFactory = (await ethers.getContractFactory(
      "Stable",
      owner
    )) as StableCoinToken__factory;

   
    stableCoinToken = await stableCoinTokenFactory.deploy();
    await 
  });
